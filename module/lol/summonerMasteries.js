...
module.exports = {
    SummonerMasteries: class SummonerMasteries {
        ...
        /**
         * Step 1 : Get AccountDTO
         * Step 2 : Get SummonerDTO
         * Step 3 : Use encryptedSummoner for get Masteries
         * @param {*} params 
         */
        constructor(params) {
            ...
            this.encryptedPuuid = params.puuid;
        ...
        getUrlBySummonerName(encryptedPuuid, region) {
            if (!encryptedPuuid) { encryptedPuuid = this.encryptedPuuid; }
            if (!region) { region = this.region; }

            let baseUrl = routeInfo.lol.routes.championMastery.v4.getChampionMasteriesByPuuid;
